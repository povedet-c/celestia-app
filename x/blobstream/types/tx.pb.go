...
// source: celestia/qgb/v3/tx.proto
...
func (*MsgRegisterEVMAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_9d89ad9d6960bc85, []int{0}
}
...
func (*MsgRegisterEVMAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9d89ad9d6960bc85, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgRegisterEVMAddress)(nil), "celestia.qgb.v3.MsgRegisterEVMAddress")
	proto.RegisterType((*MsgRegisterEVMAddressResponse)(nil), "celestia.qgb.v3.MsgRegisterEVMAddressResponse")
}

func init() { proto.RegisterFile("celestia/qgb/v3/tx.proto", fileDescriptor_9d89ad9d6960bc85) }

var fileDescriptor_9d89ad9d6960bc85 = []byte{
	...
	0xd0, 0x82, 0x77, 0x0b, 0x3d, 0x16, 0x64, 0x05, 0x0f, 0x5e, 0x4a, 0xb6, 0x0d, 0x31, 0xb0, 0xbb,
	...
	0xaa, 0xd2, 0x28, 0x07, 0x9a, 0x0d, 0xba, 0xbf, 0xb2, 0x01, 0x5f, 0x61, 0x02, 0x31, 0xaa, 0xd3,
	...
	0x9e, 0xad, 0xe4, 0x44, 0xd8, 0x9c, 0xed, 0xff, 0xfa, 0x4f, 0xe7, 0xe2, 0x6d, 0xca, 0xc8, 0x64,
	0xca, 0xc8, 0xd7, 0x94, 0x91, 0xc7, 0x19, 0x2b, 0x4d, 0x66, 0xac, 0xf4, 0x39, 0x63, 0xa5, 0xeb,
	0x33, 0x6d, 0xdc, 0xcd, 0x6d, 0xc0, 0x07, 0x10, 0x89, 0x22, 0x19, 0xac, 0x5e, 0xd6, 0x2d, 0x99,
	0x24, 0x62, 0x2c, 0x82, 0x10, 0x02, 0x74, 0x56, 0xc9, 0x48, 0xb8, 0xbb, 0x44, 0x61, 0xb0, 0xbe,
	0xd8, 0x4b, 0xfb, 0x27, 0x00, 0x00, 0xff, 0xff, 0x81, 0x54, 0x03, 0x76, 0x13, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) RegisterEVMAddress(ctx context.Context, in *MsgRegisterEVMAddress, opts ...grpc.CallOption) (*MsgRegisterEVMAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/celestia.qgb.v3.Msg/RegisterEVMAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterEVMAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/celestia.qgb.v3.Msg/RegisterEVMAddress",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "celestia.qgb.v3.Msg",
	...
	Metadata: "celestia/qgb/v3/tx.proto",
}
